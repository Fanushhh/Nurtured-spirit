    ...
    return(
        <section className="reikiSection">
            <div class="linksContainer">
                <Link to='/Nurtured-spirit-project/'>Homepage <span className='arrow'>{'>'}</span></Link>
                <Link to="/Nurtured-spirit-project/services">Services <span className='arrow'>{'>'}</span></Link>
                <span>Reiki</span>
            </div>
            <h1>Reiki</h1>
